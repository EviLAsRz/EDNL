//IMPLEMENTACIÓN DEL TAD ABIN MEDIANTE CELDAS ENLAZADAS
...
class Abin
{
  ...
  public:
    ...
    /*
    Declaracion funciones ejercicio 4.
    */
...
/*
---------------------------------------------------------------------------------------------
*EJERCICIO 5. Añade dos nuevas operaciones al TAD árbol binario, una que calcule la profundidad de un
* nodo y otra que calcule la altura de un nodo en un árbol dado.
---------------------------------------------------------------------------------------------
*/

//Profundidad de un nodo dado (hacer iterativa)
template <typename T>
